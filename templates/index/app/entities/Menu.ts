...
export default class MenuEntity {
  ...
  constructor(props?: IMenuProps | null) {
    this._props = EmptyMenuPropsFactory(props)
    this._current = null
  }
...
export const EmptyMenuPropsFactory = (props?: Partial<IMenuProps | null>): IMenuProps => ({
  id: null,
  title: null,
  disabled: false,
  sortable: false,
